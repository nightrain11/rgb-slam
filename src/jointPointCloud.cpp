...
int main( int argc, char** argv )
{
    ...
    //读取图像
    frame1.rgb = cv::imread( "../data1/rgb_png/1.png");
    if(frame1.rgb.empty())
    cout<<"error";
    cout<<"wrong!";
    frame1.depth = cv::imread( "../data1/depth_png/1.png", -1);
    frame2.rgb = cv::imread( "../data1/rgb_png/2.png");
    frame2.depth = cv::imread( "../data1/depth_png/2.png", -1);
